# PROJECT-ON-POWER-BI-UPDATE-IN-SALES-ANALYSIS-PROJECT-
This is the same project i have did in october , i analyse it today and find some mistakes and now i have corrected it and formed this repository to  update the same project 
sales data based on varies factors 🔹 Step 1: Data Import
...
Share dashboard access with stakeholders. Significance of the Sales Analytics Dashboard Project
